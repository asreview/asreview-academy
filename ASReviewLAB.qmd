...
First, before you start the tutorial ASReview LAB needs to be installed. For instructions on how to install ASReview LAB, please visit the [ASReview website](https://asreview.nl/download/){target="_blank"}.
