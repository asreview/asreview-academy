--- title: "Introductory exercise on Using the ASReview Simulation Mode" author: "The ASReview Academy Team" ---
...
Makita also contains a [template](https://github.com/asreview/asreview-makita#multiple-models-template){target="_blank"} to easily compare multiple models.
