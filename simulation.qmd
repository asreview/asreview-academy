...
![](images/Simulation/Folderstructure.png){width=85%}
...
![](images/Simulation/Example_recall_curve.png){width=85%}
...
not have to screen 65% of the records to find 85% of relevant records in
the dataset.
